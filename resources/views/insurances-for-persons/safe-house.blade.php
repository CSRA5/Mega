...
@section('title','Seguro domiciliario-Mega Corredores de Seguros')
@section('description','')
...
<section>
	...
	<div class="container">
			...
			<div class="panel-group panel-group-secondary" id="accordion2">
 			 ...
 			 @section('insurance')
			<input type="email" value="Seguro domiciliario" data-msg-required=" " data-msg-email=" " maxlength="100"  name="insurance" id="insurance" required style="display:none">
			@endsection
